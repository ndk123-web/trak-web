  ...
  const navSections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "trak verify", href: "/cli/verify", icon: Terminal, isCode: true },
                    ...
                    >
                      ...
                      {!isCollapsed && (
                        <div className="flex items-center gap-1.5 shrink-0">
                          ...
                          {item.isNew && (
                            <span className="px-1.5 py-0.2 rounded bg-emerald-500/15 text-emerald-400 border border-emerald-500/25 text-[9px] font-mono font-bold">
                              NEW
                            </span>
                          )}
                        </div>
