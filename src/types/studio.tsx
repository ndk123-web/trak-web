...
// Crisp Vector SVG Language Icons
export function FileIconSvg({ filename, className = "w-3.5 h-3.5" }: { filename: string; className?: string }) {
  ...
  if (ext === "md" || ext === "markdown") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <rect width="24" height="24" rx="4" fill="#10B981" fillOpacity="0.15" stroke="#10B981" strokeWidth="1.2" />
        <path d="M5 16V8L8 11.5L11 8V16M15 12L17.5 15L20 12M17.5 8V15" stroke="#10B981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  if (ext === "sql") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <ellipse cx="12" cy="6" rx="8" ry="3" fill="#818CF8" fillOpacity="0.2" stroke="#818CF8" strokeWidth="1.5" />
        <path d="M4 6V12C4 13.66 7.58 15 12 15C16.42 15 20 13.66 20 12V6" stroke="#818CF8" strokeWidth="1.5" />
        <path d="M4 12V18C4 19.66 7.58 21 12 21C16.42 21 20 19.66 20 18V12" stroke="#818CF8" strokeWidth="1.5" />
      </svg>
    );
  }
  ...
  if (ext === "json") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <rect width="24" height="24" rx="4" fill="#F59E0B" fillOpacity="0.15" stroke="#F59E0B" strokeWidth="1.2" />
        <path d="M8 8C7 8 6 9 6 10.5V11C6 11.5 5.5 12 5 12C5.5 12 6 12.5 6 13V13.5C6 15 7 16 8 16M16 8C17 8 18 9 18 10.5V11C18 11.5 18.5 12 19 12C18.5 12 18 12.5 18 13V13.5C18 15 17 16 16 16" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  if (ext === "yml" || ext === "yaml" || ext === "toml") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <rect width="24" height="24" rx="4" fill="#F43F5E" fillOpacity="0.15" stroke="#F43F5E" strokeWidth="1.2" />
        <path d="M7 8L12 13L17 8M12 13V18" stroke="#F43F5E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  if (ext === "sh" || ext === "bash" || ext === "ps1" || ext === "zsh") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <rect width="24" height="24" rx="4" fill="#14B8A6" fillOpacity="0.15" stroke="#14B8A6" strokeWidth="1.2" />
        <path d="M6 8L10 12L6 16M12 16H18" stroke="#14B8A6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  if (ext === "c" || ext === "cpp" || ext === "h" || ext === "hpp") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <rect width="24" height="24" rx="4" fill="#60A5FA" fillOpacity="0.15" stroke="#60A5FA" strokeWidth="1.2" />
        <text
          x="12"
          y="16.5"
          fill="#60A5FA"
  ...
  if (ext === "java") {
    return (
      <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
        <rect width="24" height="24" rx="4" fill="#ED8B00" fillOpacity="0.15" stroke="#ED8B00" strokeWidth="1.2" />
        <path
  ...
  return (
    <svg className={`${className} shrink-0`} viewBox="0 0 24 24" fill="none">
      ...
      />
      <path d="M14 2V7H19" stroke="#94A3B8" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
